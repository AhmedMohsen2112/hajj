    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-4">
                    <label class="col-sm-4 inputbox utbox control-label">{{_lang('app.buses')}}</label>
                    <div class="col-sm-8 inputbox">
...
<div class="table-toolbar">
    <div class="row">
        <div class="col-md-6">
            <div class="btn-group">
                <a class="btn green" href="{{ route('buses_accommodation.create') }}">{{ _lang('app.add_new')}}<i class="fa fa-plus"></i> </a>
            </div>
            <div class="btn-group">
                <a class="btn btn-warning" href="" onclick="BusesAccommodation.truncate(); return false;">{{ _lang('app.emptying')}}</a>
            </div>
            <div class="btn-group">
                <form action="{{url('admin/buses_accommodation/download')}}" method="post">
                    {{ csrf_field() }}
                    <input type="hidden" name="location"  value="{{ (isset($location)) ?$location:''}}">
                    <input type="hidden" name="gender" value="{{ (isset($gender)) ?$gender:''}}">
                    <input type="hidden" name="building" value="{{ (isset($bus)) ?$bus:''}}">
