  ...
  <div>
    ...
    <div class="content" style="background-image: linear-gradient( #6a7ca0, #a0c2de ); width:100%; padding:10px 0;" >
        <header class="clearfix" style="padding: 10px 0;margin-bottom: 10px; padding: 0 5px;">
            <div class="bottom-header" style="display: block; padding:0 25px 0 0;">
                <h2 style="color:#fff; font-size: 36px; text-align: right;font-family: sans-serif;margin:0; font-weight: bold; width:50%; float:right;">شـركــــة</h2>
                <h3 style="margin:0; width:40%; float:left; padding-left: 25px;"><img style="width:100px;height:100px;" src="{{ $pilgrim->qr_image }}"></h3>
            </div>
          <div id="logo" style="width:70%;margin: 0 auto;display: block;">
            <img src="{{ url('public/backend/images') }}/logo-card-header.png">
          </div>
        </header>
