            ...
            <div class="form-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-4">
                        <input type="hidden" name="input_pdf[{{ $key }}]" value="{{isset($category->pdf->$key)?$category->pdf->$key:''}}">
                        <a href="{{isset($category->pdf->$key)?url('public/uploads/categories/'.$category->pdf->$key):''}}">{{_lang('app.view')}}</a>
            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input col-md-4">
                    <select class="form-control edited" id="pdf_status" name="pdf_status">
                        <option {{ $category->pdf_status == 0 ?'selected' : '' }} value="0">{{ _lang('app.not_active') }}</option>
                        <option {{ $category->pdf_status == 1 ?'selected' : '' }} value="1">{{ _lang('app.active') }}</option>
                    </select>
