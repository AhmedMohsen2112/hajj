    ...
    <div class="panel panel-default" id="editSiteSettings">
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input col-md-3">
                    <select class="form-control" id="male_profile_image" name="setting[male_profile_image]">
                        <option {{ isset($settings['male_profile_image']) && $settings['male_profile_image']->value == 0 ? 'selected' : '' }} value="0">{{ _lang('app.not_required') }}</option>
                        <option {{ isset($settings['male_profile_image']) && $settings['male_profile_image']->value == 1 ? 'selected' : '' }} value="1">{{ _lang('app.required') }}</option>

                    </select>
                    <label for="male_profile_image">{{_lang('app.male_profile_image') }}</label>
                    <span class="help-block"></span>
                </div>
                <div class="form-group form-md-line-input col-md-3">
                    <select class="form-control" id="male_profile_image" name="setting[female_profile_image]">
                        <option {{ isset($settings['female_profile_image']) && $settings['female_profile_image']->value == 0 ? 'selected' : '' }} value="0">{{ _lang('app.not_required') }}</option>
                        <option {{ isset($settings['female_profile_image']) && $settings['female_profile_image']->value == 1 ? 'selected' : '' }} value="1">{{ _lang('app.required') }}</option>

                    </select>
                    <label for="female_profile_image">{{_lang('app.female_profile_image') }}</label>
                    <span class="help-block"></span>
                </div>
