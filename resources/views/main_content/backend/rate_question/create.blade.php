                             ...
                             <tr class="answer-one">
                                <td>
                                    <div class="form-group">
                                        <input type="hidden" name="answers[0][id]" value="">
                                        <input placeholder="order" style="width: 100px;" type="number" class="form-control form-filter input-lg"  name="answers[0][order]" value="">
                                        <span class="help-block"></span>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="form-group">
                                         <input type="hidden" name="answers[0][translations][{{ $key }}][id]" value="">
                                        <input  placeholder="{{ $key }}" type="text" class="form-control form-filter input-lg"  name="answers[0][translations][{{ $key }}][title]" value="">
