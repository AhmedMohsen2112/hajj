                ...
                <div class="col-md-12" style="margin-top: 20px;">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-group form-md-line-input">
                            <textarea class="form-control" id="about_text[{{ $key }}]" name="setting[about_text][{{ $key }}]"  cols="30" rows="10">{{isset($settings['about_text'])&&isset($settings['about_text']->$key)?$settings['about_text']->$key:''}}</textarea>
               ...
               <div class="col-md-12" style="margin-top: 20px;">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                         ...
                         <span>{{_lang('app.video_must_not_be_greeter_than_2MP')}}</span>
