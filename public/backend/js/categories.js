...
var Categories = function () {
    ...
    var init = function () {
        ...
        handleRecords();
        handleSubmit();
        //handleChangePdfStatus();
    };
    var handleChangePdfStatus = function () {
        $('select[name="pdf_status"]').on('change', function () {
            var value = $(this).val();
            ...
            if (parent_id != 0) {
                ...
                if (value == 1) {
                    for (var x = 0; x < langs.length; x++) {
                        var input_pdf = "input[name='input_pdf[" + langs[x] + "]']";
                        var image = "input[name='pdf[" + langs[x] + "]']";
                        if (!$(input_pdf).val()) {
                            $(image).rules('add', {
                                required: true,
                                accept: "pdf",
