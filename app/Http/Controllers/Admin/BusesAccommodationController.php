...
//        'gender' => 'required',
    ...
    public function download(Request $request) {
        ...
        $pdf = PDF::loadView('main_content.backend.pdf.bus_accommodation', $this->data, [50, 100]);
