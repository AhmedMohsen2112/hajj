...
class RateQuestionsController extends BackendController {
    ...
    public function show($id) {
        $RateQuestion = RateQuestion::join('rate_questions_translations','rate_questions.id','=','rate_questions_translations.rate_question_id')
                ->where('rate_questions.id',$id)
        ...
        $rateQuestionAnswers = RateQuestionAnswer::join('rate_question_answers_translations','rate_question_answers.id','=','rate_question_answers_translations.rate_question_answer_id')
                ->where('rate_question_answers.rate_question_id', $id)
                ->where('rate_question_answers_translations.locale', $this->lang_code)
                ->select('rate_question_answers.id','rate_question_answers.count_of_raters','rate_question_answers_translations.title')
                ->get();
