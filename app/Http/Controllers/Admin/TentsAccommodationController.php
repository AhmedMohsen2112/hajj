...
//        'gender' => 'required',
    ...
    public function index(Request $request) {
        ...
        $this->data['tents'] = Tent::orderBy('this_order', 'ASC')->get();
    ...
    public function download(Request $request) {
        //dd($request->all());
        $request->except('per_page');
        
        $this->data['pilgrims'] = TentAccommodation::gePilgrimsWithAccommodation(['filter' => $request->all()]);
        Config::set('pdf.margin_top', '5');
        Config::set('pdf.margin_right', '0');
        Config::set('pdf.margin_left', '0');
        Config::set('pdf.margin_bottom', '5');
        Config::set('pdf.title', _lang('app.report'));
        $pdf = PDF::loadView('main_content.backend.pdf.tent_accommodation', $this->data, [50, 100]);
