...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::get('ajax/getLounges', 'AjaxController@getLounges')->name('ajax.getLounges');
    Route::get('ajax/getFloors', 'AjaxController@getFloors')->name('ajax.getFloors');
    Route::get('ajax/getRooms', 'AjaxController@getRooms')->name('ajax.getRooms');
    ...
    Route::post('pilgrims/truncate', 'PilgrimsController@truncate');
    ...
    Route::post('suites_accommodation/truncate', 'SuitesAccommodationController@truncate');
    Route::post('suites_accommodation/download', 'SuitesAccommodationController@download');
    Route::post('buses_accommodation/notify', 'BusesAccommodationController@notify');
    Route::post('buses_accommodation/truncate', 'BusesAccommodationController@truncate');
    Route::post('buses_accommodation/download', 'BusesAccommodationController@download');
    Route::post('tents_accommodation/notify', 'TentsAccommodationController@notify');
    Route::post('tents_accommodation/truncate', 'TentsAccommodationController@truncate');
    Route::post('tents_accommodation/download', 'TentsAccommodationController@download');
    Route::post('buildings_accommodation/notify', 'BuildingsAccommodationController@notify');
    Route::post('buildings_accommodation/truncate', 'BuildingsAccommodationController@truncate');
    Route::post('buildings_accommodation/download', 'BuildingsAccommodationController@download');
